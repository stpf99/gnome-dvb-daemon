...
namespace DVB {
    ...
    public enum DvbSrcDelsys {
        ...
        SYS_TURBO,
        SYS_DVBC_ANNEX_C,
        SYS_DVBS2X,  // Added for DVB-S2X
        SYS_DVBC2    // Added for DVB-C2
    }

    // Define ModulationType enum explicitly to include DVB-C2 modulations
    public enum ModulationType {
        ...
        APSK_128,
        APSK_256,
        QAM_1024,  // Added for DVB-C2
        QAM_4096   // Added for DVB-C2
    }
   ...
   /* mpegts converts */
    private DVBCodeRate getCodeRateEnum (string val) {
        switch (val) {
            ...
            case "13/45":  // Extended code rates for DVB-S2X
                return DVBCodeRate.@13_45;
            case "9/20":
                return DVBCodeRate.@9_20;
            case "11/20":
                return DVBCodeRate.@11_20;
            case "5/9":
                return DVBCodeRate.@5_9;
            case "26/45":
                return DVBCodeRate.@26_45;
            case "28/45":
                return DVBCodeRate.@28_45;
            case "23/36":
                return DVBCodeRate.@23_36;
            case "25/36":
                return DVBCodeRate.@25_36;
            case "13/18":
                return DVBCodeRate.@13_18;
            case "NONE":
    ...
    private string getCodeRateString (DVBCodeRate val) {
        switch (val) {
            ...
            case DVBCodeRate.@9_10:
                return "9/10";
            case DVBCodeRate.@13_45:  // Extended code rates for DVB-S2X
                return "13/45";
            case DVBCodeRate.@9_20:
                return "9/20";
            case DVBCodeRate.@11_20:
                return "11/20";
            case DVBCodeRate.@5_9:
                return "5/9";
            case DVBCodeRate.@26_45:
                return "26/45";
            case DVBCodeRate.@28_45:
                return "28/45";
            case DVBCodeRate.@23_36:
                return "23/36";
            case DVBCodeRate.@25_36:
                return "25/36";
            case DVBCodeRate.@13_18:
                return "13/18";
    ...
    private ModulationType getModulationEnum (string val) {
        switch (val) {
            ...
            case "APSK/64":           // Extended modulations for DVB-S2X
                return ModulationType.APSK_64;
            case "APSK/128":
                return ModulationType.APSK_128;
            case "APSK/256":
                return ModulationType.APSK_256;
            case "QAM/1024":          // Added for DVB-C2
                return ModulationType.QAM_1024;
            case "QAM/4096":          // Added for DVB-C2
                return ModulationType.QAM_4096;
            default:
                return ModulationType.QAM_AUTO;
        }
    }
    ...
    private string getModulationString (ModulationType val) {
        switch (val) {
            ...
            case ModulationType.QAM_4_NR_:
                return "QAM/4_NR";
            case ModulationType.APSK_64:      // Extended modulations for DVB-S2X
                return "APSK/64";
            case ModulationType.APSK_128:
                return "APSK/128";
            case ModulationType.APSK_256:
                return "APSK/256";
            case ModulationType.QAM_1024:     // Added for DVB-C2
                return "QAM/1024";
            case ModulationType.QAM_4096:     // Added for DVB-C2
                return "QAM/4096";
            default:
                return "QAM/AUTO";
        }
    ...
    private bool isSupported (DvbSrcDelsys delsys, AdapterType type) {
        switch (delsys) {
            ...
            case DvbSrcDelsys.SYS_DVBC2:         // Added DVB-C2
            ...
            case DvbSrcDelsys.SYS_DVBS2X:        // Added DVB-S2X
