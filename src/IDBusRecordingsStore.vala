...
namespace DVB {
    ...
    public interface IDBusRecordingsStore : GLib.Object {
         ...
         */
        public abstract uint32[] GetRecordings () throws DBus.Error;
         ...
         */
        public abstract bool GetLocation (uint32 rec_id, out string location) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetName (uint32 rec_id, out string name) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetDescription (uint32 rec_id, out string description) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetStartTime (uint32 rec_id, out uint[] start_time) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetStartTimestamp (uint32 rec_id, out int64 timestamp) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetLength (uint32 rec_id, out int64 length) throws DBus.Error;
         ...
         */
        public abstract bool Delete (uint32 rec_id) throws DBus.Error;
         ...
         * @returns: TRUE on success
         */
        public abstract bool GetChannelName (uint32 rec_id, out string name) throws DBus.Error;
         ...
         */
        public abstract bool GetAllInformations (uint32 rec_id, out RecordingInfo infos) throws DBus.Error;
