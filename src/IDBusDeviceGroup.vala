...
namespace DVB {
    ...
    public interface IDBusDeviceGroup : GLib.Object {
         ...
         * reference device.
         */
        public abstract bool AddDevice (uint adapter, uint frontend); 
         ...
         */
        public abstract bool RemoveDevice (uint adapter, uint frontend);
         ...
         */
        public abstract bool SetName (string name);
         ...
         */
        public abstract string GetRecordingsDirectory ();
        
        /**
         * @location: Location of the recordings directory
         * @returns: TRUE on success
         */
        public abstract bool SetRecordingsDirectory (string location);
